require('gitsigns').setup{
  ...
  on_attach = function(bufnr)
    ...
    vim.keymap.set('v', '<leader>hs', function() gs.stage_hunk {vim.fn.line('.'), vim.fn.line('v')} end, {desc = 'Stage Hunk in Visual Mode', buffer = bufnr})
    vim.keymap.set('v', '<leader>hr', function() gs.reset_hunk {vim.fn.line('.'), vim.fn.line('v')} end, {desc = 'Reset Hunk in Visual Mode', buffer = bufnr})
    ...
    vim.keymap.set('n', '<leader>hb', function() gs.blame_line{full=true} end, {desc = 'Blame Line', buffer = bufnr})
