-- [nfnl] Compiled from nvim-10-fzf-lua.fnl by https://github.com/Olical/nfnl, do not edit.
local fzf = require("fzf-lua")
fzf.setup({fzf_opts = {["--layout"] = "reverse-list"}, keymap = {fzf = {["ctrl-q"] = "select-all+accept"}}, winopts = {preview = {layout = "vertical", vertical = "up:70%"}}})
...
return vim.keymap.set("n", "<leader>fd", fzf.diagnostics_workspace, {desc = "Search Diagnostics"})
